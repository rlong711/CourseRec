...
classes <- course_rec_dept(c('AFR11701', 'AFR17501', 'AFR24901'), 'MTH', course_data)
classes
```
...
classes <- course_rec_exclude_day_dept(c('AFR11701', 'AFR17501', 'AFR24901'), 'Friday', 'MTH', course_data)
classes
```
