...
classes <- course_recommend('AFR11701', 'AFR17501', 'AFR24901')
classes 
```
...
classes <- course_rec_dept('AFR11701', 'AFR17501', 'AFR24901', 'MTH')
classes
```
...
classes <- course_rec_exclude_day_dept('AFR11701', 'AFR17501', 'AFR24901', 'Friday', 'MTH')
classes
```

## Course Data 

The metadata of all courses currently offered by Smith College is scraped from the online course catalog and aggregated into the 'course_data' dat set
