test_that("scrap_course_data function returns a data frame with the correct input.", {
  expect_no_error(scrap_course_data(2023, "Fall"))
})

test_that("course_recommend prints out desired output", {
  expect_no_error(course_recommend(c("AFR11701", "ARH21701", "BIO12302"), course_data))
})
